                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        if (id == R.id.settingsId) {
                            ...
                            startActivity(new Intent(Booked.this,settings.class));

                        } else if (id == R.id.logoutId){

                            FirebaseAuth.getInstance().signOut();
                            finish();
                            Intent signOUT=new Intent(Booked.this,loginActivity.class);
                            startActivity(signOUT);


                        } else if (id == R.id.homeId){

                            startActivity(new Intent(Booked.this,Mynavigation.class));

                        } else if (id == R.id.myservicesId){

                            startActivity(new Intent(Booked.this,myServices.class));
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.buttonServices:
                startActivity(new Intent(this,myServices.class));
                break;
