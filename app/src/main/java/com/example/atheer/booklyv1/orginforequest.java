...
public class orginforequest extends AppCompatActivity  implements View.OnClickListener{
    ...
    private void Approve(){
        ...
        Toast.makeText(orginforequest.this,"Organization has been approved",Toast.LENGTH_LONG).show();
    ...
    private void Disapprove(){
        ...
        Intent prev = new Intent(orginforequest.this, approveOrgByadmin.class);
        startActivity(prev);
        Toast.makeText(orginforequest.this,"Organization has been Disapproved ",Toast.LENGTH_LONG).show();
    }
