...
public class mynav2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mynav2);
        setTitle("Home");
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        if (id == R.id.settingsId) {
                            ...
                            startActivity(new Intent(mynav2.this,settings.class));

                        } else if (id == R.id.logoutId){

                            FirebaseAuth.getInstance().signOut();
                            finish();
                            Intent signOUT=new Intent(mynav2.this,loginActivity.class);
                            startActivity(signOUT);


                        } else if (id == R.id.homeId){

                            startActivity(new Intent(mynav2.this,mynav2.class));

                        } else if (id == R.id.myservicesId){

                            startActivity(new Intent(mynav2.this,myServices.class));
